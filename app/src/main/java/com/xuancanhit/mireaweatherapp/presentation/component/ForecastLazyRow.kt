    ...
    Card(
        ...
        Column(
            ...
            Column(modifier = Modifier.fillMaxWidth(), horizontalAlignment = Alignment.CenterHorizontally) {
                if (date != null) {
                    Text(text = date, style = MaterialTheme.typography.displaySmall.copy(fontSize = 18.sp))
                }
                Text(text = time, style = MaterialTheme.typography.displaySmall.copy(fontSize = 18.sp))
            }
            Image(
            ...
            Text(text = degree, style = MaterialTheme.typography.displaySmall.copy(fontSize = 24.sp))
        }
    }
}